...
export const sourcePlatformSchema = z.enum(["ctrader", "mt5", "binance", "bybit", "custom"]);
...
export type NormalizedTradePayloadInput = z.infer<typeof normalizedTradePayloadSchema>;
